...
void main() {
  runApp(SwipableStackEx());
}

class SwipableStackEx extends StatelessWidget {
          ...
          children: [
            SwipableStack(
              ...
              onSwipeCompleted: (index, direction) {
                ...
                print('currentIndex:${_controller.currentIndex}');
              },
              overlayBuilder: (
                context,
                constraints,
...
class _BottomButton extends StatelessWidget {
  const _BottomButton({
    Key? key,
    @required this.onPressed = onPressedStacked,
    @required this.child = const Icon(Icons.arrow_downward),
    @required this.color = SwipeDirectionColor.down,
  }) : super(key: key);
